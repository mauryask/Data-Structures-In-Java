...
/*
* Refer: NextSmallerElementToRightAndLeftAtTheSmaseTime 
* The above algorithm to get the next smallest and previous smallest at the smae time
**/
...
public class MaxAreaRectangleInBinaryMatrix {
    ...
    static int maxArea(int A[][], int m, int n) {
        ...
        for (int i = 0; i < m; i++) {
            ...
            maxArea = Math.max(maxArea, MaxAreaHistogram.maxAreaHistogram(height, n));
        }
