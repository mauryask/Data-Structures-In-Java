...
public class BinaryTreeToDLLRecursive {
    ...
    static void postOrderConversion(Node root) {		
        if (root == null) {
            return;        
        }

		postOrderConversion(root.left);
		postOrderConversion(root.right);
        
		// This is important step to set the right pouinter of the root to null at the end
		root.right = null;
